 ...
 * Purpose: Generate personal requisition reports (Team Member view)
 */
...
// Generate report
$reportData = $report->generatePersonalReport($filters, $page, 15);
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="content-title">
                <i class="fas fa-chart-bar me-2"></i>My Requisition Reports
            </h1>
            <p class="content-subtitle">View and analyze your requisition history</p>
        </div>
...
<div class="alert alert-info mt-4">
    <h6 class="alert-heading">
        <i class="fas fa-info-circle"></i> About Your Reports
    </h6>
    <p class="mb-0">
        This report shows all your requisitions. Use the filters below to narrow down results by time period or status.
        Export to Excel for offline analysis and record keeping.
    </p>
</div>
...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">
                <i class="fas fa-list"></i> Report Results
            </h5>
    ...
    <div class="card-body">
        <?php if (empty($requisitions)): ?>
            <div class="empty-state">
                ...
                <a href="<?php echo BASE_URL; ?>/requisitions/create.php" class="btn btn-primary mt-3">
                    ...
                    <tbody>
                        <?php foreach ($requisitions as $req): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($req['department_name'] ?? 'N/A'); ?></td>
                                <td class="text-end">
